...
// import material UI table and button
...
// const CharacterTable = (props) => {
    ...
    const headCells = [
      ...
      { id: 'race', numeric: true, disablePadding: false, label: 'Race' },
      { id: 'gender', numeric: true, disablePadding: false, label: 'Gender' },
      { id: 'age', numeric: true, disablePadding: false, label: 'Age' },
      { id: 'alignment', numeric: true, disablePadding: false, label: 'Alignment' },
      { id: 'profession', numeric: true, disablePadding: false, label: 'Profession' },
      { id: 'trait', numeric: true, disablePadding: false, label: 'Trait' },
    ];
